...
teaser: "Wanna create a responsive gallery to showcase your portfolio, recent photos or images? It's quite easy thanks to Foundation and <a href='https://foundation.zurb.com/docs/components/clearing.html'>Clearing Lightbox</a>."
categories:
    - design
tags:
    - post format
...
{% include list-posts tag='post format' %}
 ...
 [1]: https://foundation.zurb.com/docs/components/clearing.html
 [2]: https://foundation.zurb.com/docs/components/block_grid.html
