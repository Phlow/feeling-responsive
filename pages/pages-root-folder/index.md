...
widget2:
  title: "Why use VisIt?"
  url: '/visit-top-50/'
  text: '<em>VisIt</em> is extremely scalable.<br/>1. Runs on Unix, Windows & OSX<br/>2. Is Free, <a href="https://github.com/visit-dav/visit/blob/develop/LICENSE">BSD Open Source</a>.<br/>3. Uses <a href="https://vtk.org">VTK</a> & <a href="https://python.org">Python</a>.<br/>4. Reads 130+ <a href="https://www.visitusers.org/index.php?title=Detailed_list_of_file_formats_VisIt_supports">File Formats</a>.<br/>5. Installed on many <a href="https://science.osti.gov/User-Facilities">LCFs</a>'
