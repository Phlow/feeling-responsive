...
* [<s>Submit <em>Feeling Responsive</em> to jekyllthemes.org</s>](https://jekyllthemes.org/themes/feeling-responsive/)
...
* [<s>Additional header with text</s>]({{ site.baseurl }}/headers/)
...
* [<s>Step-by-Step-Guide to customize *Feeling Responsive*</s>]({{ site.baseurl }}/getting-started/)
* [<s>Video-Post-Format to feature videos in a huge way</s>]({{ site.baseurl }}/design/video/)
...
* [<s>Gallery Post Example</s>]({{ site.baseurl }}/design/gallery/)
